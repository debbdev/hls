...
<div class="home-wrap">
     ...
     <div class="head-left admin-left">
        <a href="admin_home.php"><i class="fa-solid fa-graduation-cap fa-1x"></i>DMGS</a>
    </div>
    <div class="head-right admin-right">
        <div class="head-bar"><a href="admin_home.php" class="">Home</a></div>
        <div class="head-bar"><a href="signup_hm.php" class="">Appoint Hostel Manager</a></div>
        <div class="head-bar"><a href="remove_hm.php" class="">Remove Hostel Manager</a></div>
        <div class="head-bar"><a href="students.php" class="">Students</a></div>
        <div class="head-bar"><a href="admin_profile.php" class=""><?php echo $_SESSION['firstname']." ".$_SESSION['lastname'];?></a></div>
